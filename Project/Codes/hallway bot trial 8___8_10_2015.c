...
else if(front_sensor < 120 && left_sensor > 95 && left_sensor < 155) // if obstacle ahead
{
  left_motor = 100;
	right_motor = 228;	
 ...
 {
	prop = 15 + (100 - left_sensor)*(25 - 15)/(100-85); 
	
	for(i=0;i <= 20; i++)                       //TURN RIGHT
	{
  ...
  {
	prop = 15 + (left_sensor - 100)*(25 - 15)/(115-100); 
	
	for(i=0;i <= 20; i++)					  //TURN LEFT
	{
...
else if(front_sensor <= 120 && left_sensor >= 155)		  //if obtstacle ahead and bot too close to right wall, TURN LEFT
{
	//turn left
	left_motor = 100;
	right_motor = 228;
	
	prop = 18 + (left_sensor - 115)*(25 - 18 )/(200 - 115);
...
else if(front_sensor <= 120 && left_sensor <= 95)			// if obstacle ahead and bot is too close to left wall, TURN RIGHT
{
	//turn right
	left_motor = 100;
	right_motor = 228;
	
	prop = 18 + (85 - left_sensor)*(25 - 18 )/(85 - 25);
...
else if(front_sensor > 120 && left_sensor > 155 && left_sensor < 200) //if all clear ahead but bot is close to right wall, TURN LEFT 
{
	left_motor = 100;
	right_motor = 228;
...
else if(front_sensor > 120 && left_sensor < 95)			   //if all clear ahead but bot is close to left wall, TURN RIGHT
{
	//TURN RIGHT
	...
	prop = 15 + (85 - left_sensor)*(25 - 15)/(85-25);
...
else if(front_sensor > 120 && left_sensor > 95 && left_sensor < 155)   //moving forward when there is no obstacle or wall ahead
{
	left_motor = 100;
	right_motor = 228;
