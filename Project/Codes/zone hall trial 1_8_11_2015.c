if(front_sensor <= 25 || front_sensor > 1200 && left_sensor <= 35)	  // if wall ahead
{
...
else if(front_sensor > 150 && left_sensor > 100 && left_sensor < 145)	  //when bot is in center of hallway
{
	left_motor = 100;
	right_motor = 228;
...
else if(front_sensor > 150 && left_sensor > 25 && left_sensor < 100)           // when bot is in zone 1, near left wall
{
	zone = 1;
...
else if(front_sensor > 150 && left_sensor > 100)			 //when bot is in zone 4, near right wall
{
	zone = 4;
