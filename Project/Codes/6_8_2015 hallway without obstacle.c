...
if(front_sensor > 35 && left_sensor > 60 && left_sensor < 170)   //moving forward when there is no obstacle or wall ahead
{
	left_motor = 100;
	right_motor = 228;
...
else if(front_sensor <= 35 && left_sensor <= 60)			// if obstacle ahead and bot is too close to left wall
{
	//turn right
...
else if(front_sensor <= 35 && left_sensor >= 170)		  //if obtstacle ahead and bot too close to right wall
{
	//turn left
...
else if(front_sensor < 35 && left_sensor > 60 && left_sensor < 170) // if obstacle ahead
{
	
	
 if(left_sensor < 100)                           //Turn Right
 {
...
else if(front_sensor > 35 && left_sensor < 60)
{
	//turn right
	  if(left_motor >= 85 && left_motor < 127)
   {
...
else if(front_sensor > 35 && left_sensor > 170)
{
	//turn left
	  if(left_motor >= 85 && left_motor < 127)
   {
